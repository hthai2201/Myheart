...
!(function (t, e) {
  ...
  for (;;) {
    try {
      if (
        991354 ===
        (parseInt("1tKVmYD") / 1) * (parseInt("1962124IEKwBz") / 2) +
          -parseInt("4019739LTSFlD") / 3 +
          (-parseInt("4Tksulf") / 4) * (-parseInt("2224160aelhtN") / 5) +
          parseInt("6741900MMKsYG") / 6 +
          (parseInt("4427220TLFwmf") / 7) * (-parseInt("8miZLrK") / 8) +
          parseInt("9816426BywKgu") / 9 +
          (-parseInt("1130Ldyfxh") / 10) * (parseInt("65857JXalwj") / 11)
      ) {
        break;
      }
      a.push(a.shift());
...
if (!window["Heartlove"]) {
  window.Heartlove = {
    data: {
      messages: ["Anh yêu em", "mãi yêu em"],
      images: [],
      heartColor: "#ff9090",
    },
  };
